...
@Component({
  selector: 'app-morethen10exp',
  templateUrl: './morethen10exp.component.html',
  styleUrls: ['./morethen10exp.component.css']
})
export class Morethen10expComponent {
  faculties = [
    {
      FacultyID: 1,
